...
final class FlashMessageTest extends TestCase
{
    ...
    public function testSetInvalidType(): void
    {
        ...
        $this->expectOutputString('<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>Invalid type "invalid" provided</strong><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
        $flashMessage->display();
    }
    ...
    public function testSetInvalidAction(): void
    {
        ...
        $this->expectOutputString('<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>Invalid action "invalid" provided</strong><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
        $flashMessage->display();
    }
